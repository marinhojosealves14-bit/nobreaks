...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/favicon.png?v=ftm-logo-3', type: 'image/png', sizes: '64x64' },
      { url: '/icon-dark-32x32.png?v=ftm-logo-3', type: 'image/png', sizes: '32x32' },
      { url: '/icon-light-32x32.png?v=ftm-logo-3', type: 'image/png', sizes: '32x32' },
    ],
    shortcut: '/favicon.png?v=ftm-logo-3',
    apple: '/apple-touch-icon.png?v=ftm-logo-3',
  },
  openGraph: {
